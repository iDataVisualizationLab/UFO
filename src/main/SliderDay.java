...
public class SliderDay{
	...
	public SliderDay(PApplet parent_){
		...
		w= 24*MainUFO_Version_2_5.numMins*gap+gap;
	}
		
	public void update(){
		lH = l/(MainUFO_Version_2_5.numMins);
		uH = u/(MainUFO_Version_2_5.numMins);
		lM = (l%(MainUFO_Version_2_5.numMins))*2;
		uM = (u%(MainUFO_Version_2_5.numMins))*2;
	}
	...
	public void draw(int yyy){
		...
		for (int h=0; h<25; h++ ){
			int xx = x+(h*MainUFO_Version_2_5.numMins*gap);
			if (h%12==0){
