...
public class SliderDistance{
	...
	public SliderDistance(PApplet parent_){
		parent = parent_;
		l = 200;
		u = main.MainUFO_Version_2_5.numDistance*gap;
		x= 165;
		y= MainUFO_Version_2_5.ySliders;
		w= main.MainUFO_Version_2_5.numDistance*gap+gap;
	}
	...
	public void draw(int yyy){
		...
		parent.textSize(14);
		for (int i=0; i<main.MainUFO_Version_2_5.numDistance/10;i++ ){
			int xx = x+(i*10*gap);
		...
		parent.strokeWeight(2f);
		parent.line(x+main.MainUFO_Version_2_5.numDistance*gap, y-8,x+ main.MainUFO_Version_2_5.numDistance*gap, y+8);
		...
		if (main.MainUFO_Version_2_5.densityButton.s)
