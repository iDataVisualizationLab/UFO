...
import static main.MainUFO_Version_2_5.*;
...
class DrawSliders {
	...
	public void drawNearestUFO6(SliderDistance sliderDistance ){
		...
		if (oldSelectedUFO != selectedUFO){
			...
			main.MainUFO_Version_2_5.isUFOselected =  new boolean[numUFO];
			main.MainUFO_Version_2_5.isUFOselected[selectedUFO] = true;
			main.MainUFO_Version_2_5.isUFOselected[i] = true;
